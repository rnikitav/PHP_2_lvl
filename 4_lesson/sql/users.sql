...
--
-- Хост: localhost
-- Время создания: Июл 15 2020 г., 20:15
...
(53, '3 change class dsadsa', 'change Class dsadsasad', '123', 0),
(60, '3 class 667', 'DELETE FROM `users` WHERE `users`.`id` = 42 787', '2 class pass 7878', 0);
